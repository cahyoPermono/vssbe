...
app.openapi(realVideoRoute, async (c) => {
    try {
        ...
        htmlContent = htmlContent
            ...
            if (path.startsWith('real_time.css'))
                return `href="${baseUrl}/vss/apiPage/${path}"`;
            return `href="${baseUrl}/vss/apiPage/${path}"`;
        })
            ...
            if (path.startsWith('../js/'))
                return `src="${baseUrl}/vss/js/${path.substring(6)}"`;
            if (path.startsWith('../dist/'))
                return `src="${baseUrl}/vss/dist/${path.substring(7)}"`;
            if (path.startsWith('font/'))
                return `src="${baseUrl}/vss/apiPage/${path}"`;
            if (path.startsWith('real_time.css'))
                return `src="${baseUrl}/vss/apiPage/${path}"`;
            if (path.includes('common.js'))
                return `src="https://icognis.imaniprima.co.id/api/common.js"`;
            return `src="${baseUrl}/vss/apiPage/${path}"`;
        })
